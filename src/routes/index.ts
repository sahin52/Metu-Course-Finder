...
import { Bolum, CourseInfo, Ders, Main, Prerequisite, Section } from '@/types/general/Bolum';
...
async function getCourseInfo(i: number, derslerDoc: Document):Promise<CourseInfo> {
    let courseCodeXpath = `//*[@id="single_content"]/form/TABLE[4]/TR[${i + 2}]/TD[2]/FONT/text()`;
    ...
    let courseInfoFetch = await fetch(
        'https://oibs2.metu.edu.tr//View_Program_Course_Details_64/main.php',
        {
            headers: {
                ...
                'sec-fetch-user': '?1',
                'upgrade-insecure-requests': '1',
                cookie: '_ga=GA1.3.313145970.1639841661; _APP_LOCALE=EN; phpSess_e7f8a2b66340bd43b00edc2a215826d5=Me2CWS88sguBhTLhgZmeBw69YjIp9oHpmUTw5zBNk87W8eAGEvbeBfUwzEYJxhUHrtgm6AdBn7P7JXRrl2ylTbmuM7TJqSBP11wOO6W1V5qkApNWvsYNBcqVDho6jg42',
    ...
    let ilkSectionIcin = 'string(//*[@id="single_content"]/form/TABLE[3]/TR[3]/TD[1]/FONT/INPUT/@VALUE)';
    let r = xpath.select(ilkSectionIcin, senctionsDoc).toString();
    let ikiChrome = '//*[@id="single_content"]/form/table[3]/tbody/tr[5]/td[1]/font/input';
    let ikiReel = 'string(//*[@id="single_content"]/form/TABLE[3]/TR[5]/TD[1]/FONT/INPUT/@VALUE)';
    p("r->", r);
...
async function getSectionBilgileri():Promise<Section[]>{
  ...
  "headers": {
    ...
    "sec-fetch-user": "?1",
    "upgrade-insecure-requests": "1",
    "cookie": "_ga=GA1.3.313145970.1639841661; _APP_LOCALE=EN; phpSess_e7f8a2b66340bd43b00edc2a215826d5=Gq3P9i2Faf1TwCtYyKx8VJZ18s09xP9tuCOmrE1MMpM0MeX0aBGAW76332w9rd0gci9JMOB0W8ZaeBiQrcd2qLam1r2Vnpi49NfM8NzswtCnVJDouW3QVV4URVKsDKZF",
    "Referer": "https://oibs2.metu.edu.tr//View_Program_Course_Details_64/main.php",
    "Referrer-Policy": "strict-origin-when-cross-origin"
  },
...
function getPrerequisite(i: number, derslerDoc: Document):Promise<Prerequisite[]> {
